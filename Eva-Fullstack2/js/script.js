document.addEventListener("DOMContentLoaded", () => {
    ...
    const productos = [
        ...
        { id: 5, nombre: "Escape Yoshimura", categoria: "Indumentaria", precio: 160000, img: "img/escape.webp",
          descripcion: "Escape  fibra carbono real, corto, excelente sonido, dbkiller de fabrica removible. ." },
        { id: 6, nombre: "Guantes Alpinestar", categoria: "Seguridad", precio: 139900, img: "img/guantes.jpg",
          descripcion: "Guantes Alpinestars SP-8 V3 Negros. Guantes racing confeccionados en piel de cabra de primera calidad altamente resistente a la abrasión y piel sintética. Incorporan protectores de nudillos SP de doble densidad y refuerzos y acolchados estratégicamente ubicados. Los SP-8 V3 han sido diseñados con un nuevo patrón de confección con costuras reducidas para ofrecer altos niveles de libertad de movimiento y confort.." },
        ...
        { id: 9, nombre: "Intercomunicador", categoria: "Indumentaria", precio: 259900, img: "img/inter.webp",
          descripcion: "El intercomunicador de moto Cardo SPIRIT DUO es un referente en calidad y tecnología Bluetooth. Equipado con el último chip Bluetooth 5.2, ofrece esenciales para motociclistas, combinando detalles, construcción robusta y durabilidad única. Con un peso de 35g y dimensiones no intrusivas, el Cardo Spirit se integra sin perjudicar la aerodinámica de los cascos modernos.." },
        { id: 10, nombre: "Mochila Alpinestar", categoria: "Seguridad", precio: 74900, img: "img/mochila.webp",
          descripcion: "Mochila Alpinestars, el accesorio definitivo que combina estilo deportivo y funcionalidad urbana. Diseñada con un perfil aerodinámico de alta resistencia, cuenta con tirantes ergonómicos acolchados que garantizan el máximo confort y un ajuste perfecto mientras conduces." },
        { id: 11, nombre: "Pack Limpiador", categoria: "Indumentaria", precio: 28990, img: "img/packLimpiador.webp",
          descripcion: "Kit Limpiador de Cadena / pack Lubricante de cadena 1 Limpiador Chain Cleaner 750 ML 1 Lubricante Xtrem Chain Road Blanco 250 ml 1 Escobilla de cadena Negra." },
        { id: 12, nombre: "Botas Alpinestar", categoria: "Seguridad", precio: 259900, img: "img/botas.jpg",
          descripcion: "Botas SMX S Waterproof Una nueva incorporación a la destacada gama SMX de Alpinestars, la SMX-S Waterproof está fabricada con microfibra resistente que incorpora atributos de rendimiento y protección líderes en su clase, además de una membrana transpirable e impermeable." }
    ];
